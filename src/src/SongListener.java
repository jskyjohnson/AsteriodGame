...
public class SongListener {
	...
	public SongListener(File songIncoming, Dictator dic) {
		// TODO Auto-generated constructor stub
		this.level = new ArrayList<String>();
		String levelIncomeing = "ASDFF";
	...
	public void generate() {
		...
		for (int spawnerLevelLength = 0; spawnerLevelLength < levelLength; spawnerLevelLength++) {
			...
			int randspawncheck3 = dictator.rand.nextInt(2) - 1;
			if (randspawncheck1 * randspawncheck2 * randspawncheck3 != 0) {
